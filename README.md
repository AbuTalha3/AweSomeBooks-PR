...
# 📖 AweSomebooks-PR <a name="about-project"></a>

AweSomeBooks, where you can add Books and Authors, and remove them as you are done with them. It allows you to edit and update books list,The app is developed using Html, CSS and Javascript
...
```sh
  cd AweSomeBooks-PR
  git clone git@github.com:AbuTalha3/AweSomeBooks-PR.git
```
...
Feel free to check the [issues page](https://github.com/AbuTalha3/AweSomeBooks-PR/issues).
